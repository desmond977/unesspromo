...
<head>
  <meta charset="utf-8">
  <title>Nutribullet 600/900 Watt – ShopEX TV</title>
  <meta name="description" content="NutriBullets are simply nutrient extractors. This is because of its capacity to completely break down fruits and vegetables – including their stems, skins, and seeds – into a delicious and highly nutritious smoothie that can be drunk immediately.">
    ...
    <main class="main__content_wrapper">
                            ...
                            <div class="">
                                <div class="hero__slider--items style4">
                                    <div class="row row-cols-md-2 row-cols-1 align-items-center">
                                        ...
                                        <div class="col">
                                            <a class="hero__slider--thumbnail bideo__play--icon glightbox" style="margin-left: 150px" href="https://www.youtube.com/watch?v=3p0lF4Mgl5w" data-gallery="video">
                ...
                <div class="row row-cols-md-2 row-cols-1  align-items-center">
                    <div class="col">
                        <div class="image__with--text__thumbnail">
                            <img class="display-block" src="../assets/img/product/nbgreen.jpg" alt="drone-image">
                        </div>
                    </div>
                    <div class="col">
                        <div class="image__with--text__content">
                            <h2 class="image__with--text__title mb-18">NutriBullets are simply nutrient extractors.</h2>
                            <p class="image__with--text__desc mb-25">The NutriBullet simply combines a powerful watt motor with its bullet exclusive cyclonic action which forces all the contents into the Nutribullets’ extractor blades, which then pulverizes and completely breaks down the pith, stalks, stems, skins, and seeds – releasing the essential nutrients, which would have otherwise been thrown away, or pass through the elementary canal without being absorbed. Hence, they are called nutrient extractors.</p> 
                                ...
                                <ul>
                                    <li class="image__with--text__percent--list mb-25">
                                        <span class="image__with--text__percent--top d-flex justify-content-between align-content-center">
                                            <span class="image__with--text__percent--content">Nutrient Extractors</span>
                                            <span class="image__with--text__percent--content">100%</span>
                                        </span>
                                    </li>
                                    <li class="image__with--text__percent--list two">
                                        <span class="image__with--text__percent--top d-flex justify-content-between align-content-center">
                                            <span class="image__with--text__percent--content">Smooth</span>
                                            <span class="image__with--text__percent--content">100%</span>
                                        </span>
                                    </li>
                                </ul>
                            ...
                            <div class="image__with--text__content--footer d-flex">
                                ...
                                <p class="image__with--text__desc mb-25">
                                    NutriBullets are simply nutrient extractors. This is because of its capacity to completely break down fruits and vegetables – including their stems, skins, and seeds – into a delicious and highly nutritious smoothie that can be drunk immediately.</p>
                            </div>    
                        </div>
                    </div>
                </div>
                ...
                <div class="row row-cols-lg-2 row-cols-md-2 row-cols-1 align-items-center">
                    <div class="col">
                        <div class="about__content">
                            <h2 class="about__content--title mb-18">ShopEX TV is the Sole Authorised Distributor of Nutribullet® in Nigeria.</h2>
                            <div class="about__content--step mb-25">
                                ...
                                <p class="about__content--desc style2">ShopEX TV is the sole authorised distributor of the Nutribullet brand in Nigeria. We are also the Number 1 Best Seller in Africa for the Nutribullet. Order original only from ShopEX and enjoy FREE delivery to your location of choice within Nigeria. You are guaranteed secure payment options, dedicated after-sales support, and return (if the product has problems).</p>
                            </div>
                    ...
                    <div class="col">
                        <div class="about__thumbnail">
                            <img class="display-block" src="../assets/img/product/nbinfo.png" alt="about-thumb">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2">
                        <div class="newsletter__content--style2 text-center position__relative">
                            ...
                            <a class="bideo__play--icon banner__video--play__icon style4 glightbox" href="https://www.youtube.com/watch?v=3p0lF4Mgl5w" data-gallery="video">
        ...
        <section class="newsletter__section section--padding">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <iframe width="520" height="315"src="https://www.youtube.com/embed/FWFwwdyliVY?autoplay=1&mute=1"></iframe>
                        
                    </div>
                    <div class="col-md-6">
                        <iframe width="520" height="315"src="https://www.youtube.com/embed/n99KIjayLMU?autoplay=1&mute=1"></iframe>
        ...
        <section class="product__details--section section--padding" id="buy" style="background: #eeeeee4a;">
            <div class="container">
                <div class="section__heading text-center mb-50">
                    ...
                    <p class="section__heading--desc">ShopEX TV is the Sole Authorised Distributor of Nutribullet® in Nigeria. Enjoy Free Delivery within Nigeria! ORDER ORIGINAL ONLY FROM SHOPEX.</p>
                </div>
                    ...
                    <div class="row row-cols-lg-2 row-cols-md-2">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="product__media--nav__items">
                                                <img class="product__media--nav__items--img" src="../assets/img/product/nbwhite.png" alt="product-nav-img">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product__media--nav__items">
                                                <img class="product__media--nav__items--img" src="../assets/img/product/nb1.png" alt="product-nav-img">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product__media--nav__items">
                                                <img class="product__media--nav__items--img" src="../assets/img/product/nbone.jpg" alt="product-nav-img">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product__media--nav__items">
                                                <img class="product__media--nav__items--img" src="../assets/img/product/nbmany.png" alt="product-nav-img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="product__media--preview__items">
                                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="../assets/img/product/nb1.png"><img class="product__media--preview__items--img" src="../assets/img/product/nb1.png" alt="product-media-img"></a>
                                                    <div class="product__badge">
                                                        <span class="product__badge--items sale">New</span>
                                                    </div>
                                                    <div class="product__media--view__icon">
                                                        <a class="product__media--view__icon--link glightbox" href="../assets/img/product/nb1.png" data-gallery="product-media-preview">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="product__media--preview__items">
                                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="../assets/img/product/nbone.jpg"><img class="product__media--preview__items--img" src="../assets/img/product/nbone.jpg" alt="product-media-img"></a>
                                                    <div class="product__badge">
                                                        <span class="product__badge--items sale">New</span>
                                                    </div>
                                                    <div class="product__media--view__icon">
                                                        <a class="product__media--view__icon--link glightbox" href="../assets/img/product/nbone.jpg" data-gallery="product-media-preview">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 18 18">
                                                                <image  width="18" height="18" xlink:href="data:image/png;base64,"/>
                                                            </svg>                                                              
                                                            <span class="visually-hidden">Media Gallery</span>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="product__media--preview__items">
                                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="../assets/img/product/nbwhite.png"><img class="product__media--preview__items--img" src="../assets/img/product/nbwhite.png" alt="product-media-img"></a>
                                                    <div class="product__badge">
                                                        <span class="product__badge--items sale">New</span>
                                                    </div>
                                                    <div class="product__media--view__icon">
                                                        <a class="product__media--view__icon--link glightbox" href="../assets/img/product/nbwhite.png" data-gallery="product-media-preview">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 18 18">
                                                                <image  width="18" height="18" xlink:href="data:image/png;base64,"/>
                                                            </svg>                                                              
                                                            <span class="visually-hidden">Media Gallery</span>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="product__media--preview__items">
                                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="../assets/img/product/nbgreen.jpg"><img class="product__media--preview__items--img" src="../assets/img/product/nbgreen.jpg" alt="product-media-img"></a>
                                                    <div class="product__badge">
                                                        <span class="product__badge--items sale">New</span>
                                                    </div>
                                                    <div class="product__media--view__icon">
                                                        <a class="product__media--view__icon--link glightbox" href="../assets/img/product/nbgreen.jpg" data-gallery="product-media-preview">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 18 18">
                                                                <image  width="18" height="18" xlink:href="data:image/png;base64,"/>
                                                            </svg>                                                              
                                                            <span class="visually-hidden">Media Gallery</span>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="product__media--preview__items">
                                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="../assets/img/product/nbinfo.png"><img class="product__media--preview__items--img" src="../assets/img/product/nbinfo.png" alt="product-media-img"></a>
                                                    <div class="product__badge">
                                                        <span class="product__badge--items sale">New</span>
                                                    </div>
                                                    <div class="product__media--view__icon">
                                                        <a class="product__media--view__icon--link glightbox" href="../assets/img/product/nbinfo.png" data-gallery="product-media-preview">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 18 18">
                                                                <image  width="18" height="18" xlink:href="data:image/png;base64,"/>
                                                            </svg>                                                              
                                                            <span class="visually-hidden">Media Gallery</span>
                        ...
                        <div class="col">
                            <div class="product__details--info">
                                    <h3 class="product__details--info__title mb-15">Nutribullet 600 Watt</h3>
                                    ...
                                    <div class="product__details--info__price mb-10 600p" id="600p">
                                        <span class="current__price">₦54,950.00</span>
                                        <span class="old__price">₦79,950.00</span>
                                    </div> 
                                    ...
                                    <div class="product__variant">
                                            ...
                                            <!-- <fieldset class="variant__input--fieldset"> -->
                                                <legend class="product__variant--title mb-8">Color : 
                                                    <div class="checkout__input--select select">
                                                        <select class="checkout__input--select__field border-radius-5" name="color" id="color">
                                        ...
                                        <div class="product__variant--list mb-15">
                                            <!-- <fieldset class="variant__input--fieldset"> -->
                                                <legend class="product__variant--title mb-8">Size : 
                                                    <div class="checkout__input--select select">
                                                        <select class="checkout__input--select__field border-radius-5" name="size" id="size">
                                        ...
                                        <div class="product__variant--list mb-15">
                                            <div class="product__details--info__meta">
                                                ...
                                                <p class="product__details--info__meta--list"><strong>Product Info:</strong>  600 Watt Package includes</p>
                                                    <p class="product_info">  A 600-watt motor base</p>
                                                    <p class="product_info">    An extractor blade</p>
                                                    <p class="product_info">    A 24 oz tall cup with a comfort lip ring</p>
                                                    <p class="product_info">    An 18 oz short cup and handled comfort lip ring</p>
                                                    <p class="product_info">  Available in Color white and Grey. </p>
                                                </div>
                                                <div id="900w">
                                                <p class="product__details--info__meta--list"><strong>Product Info:</strong>  900 Watt Package includes</p>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 mb-20">
                                                <div class="checkout__input--list ">
                                                    ...
                                                    <input class="checkout__input--field border-radius-5" id="price_600w"  type="hidden" name="price_600w" value="54950">
                                                    <input class="checkout__input--field border-radius-5" id="price_900w"  type="hidden" name="price_900w" value="54950">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 mb-20">
                                                <div class="checkout__input--list">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-7 col-sm-order">
                        <div class="deals__content">
                            <h2 class="deals__content--title text-red mb-20" style="color: #f44336">Talk to Us: 091600000</h2>
                            <h2 class="deals__content--title text-white mb-20">ShopEX TV is the Sole Authorised Distributor of Nutribullet® in Nigeria.
                    ...
                    <div class="col-lg-6 col-md-5">
                        <div class="deals__thumbnail--style3 text-right">
                            <img class="deals__thumbnail--style3__img" src="../assets/img/product/nb1.png" alt="deals-thumb">
                        </div>
                    </div>
                </div>
            </div>
...
<?php 
    if (isset($_POST['buynow'])) {
        ...
        $price = ($_POST['size'] == "600W") ? $_POST['price_600w'] : $_POST['price_600w'] ;

        $amount = $_POST['quantity'] * $price;
        $referral = $_POST['referral'];

        $qty_600white = ($_POST['color'] == "White" && $_POST['size'] == "600W") ? $_POST['quantity'] : 0 ;
        $qty_600grey = ($_POST['color'] == "Grey" && $_POST['size'] == "600W") ? $_POST['quantity'] : 0 ;
        $qty_900white = ($_POST['color'] == "White" && $_POST['size'] == "900W") ? $_POST['quantity'] : 0 ;
        $qty_900grey = ($_POST['color'] == "Grey" && $_POST['size'] == "900W") ? $_POST['quantity'] : 0 ;
        $qty_900gold = ($_POST['color'] == "Gold" && $_POST['size'] == "900W") ? $_POST['quantity'] : 0 ;
         ...
         $set_entry_parameters = array(
          ...
          "name_value_list" => array(
                ...
                array("name" => "email1", "value" => $email_address ),
                 ...
                 array("name" => "nutribullet600white", "value" => $qty_600white ),
                 array("name" => "nutribullet600grey", "value" => $qty_600grey ),
                 array("name" => "nutribullet900white", "value" => $qty_900white ),
                 array("name" => "nutribullet900grey", "value" => $qty_900grey ),
                 array("name" => "nutribullet900gold", "value" => $qty_900gold ),
          ...
          $set_entry_result = call("set_entry", $set_entry_parameters, $url);
            if ($set_entry_result) {
                echo "<script type='text/javascript'>window.top.location='https://shop.shopextv.com/nb/?status=sent';</script>"; exit;
            }
      }
 ?>