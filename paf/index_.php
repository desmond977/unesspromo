...
<head>
  <meta charset="utf-8">
  <title>Power Air Fryer 5L – ShopEX TV</title>
  <meta name="description" content="The power air fryer XL does more than air frying, it does the work of your grill, oven, stovetop, toaster oven, and steamer, all in one neat, compact, and versatile device. With a digital quick touch panel, it’s so versatile, safer, odour-free alternative to a deep fiat fryer. The secret is the 400°F, 1500 watt rapid hot technology, and fifteen air chamber. The superheating cyclonic airflow surrounds your food quickly, creating a golden brown crispy outside while locking the moisture inside. The power air fryer XL has adjustable temperature and time setting and 7 quick presets designed to cook your favourite foods at the perfect temperature for the perfect time, ‘set it and walk away’.">
...
<!--                         <li class="offcanvas__menu_li">
    ...
    <main class="main__content_wrapper">
        ...
        <!-- <a href="#"></a> -->
        <section class="hero__slider--section slider__section--bg4_paf" id="home">
                            ...
                            <div class="">
                                <div class="hero__slider--items style4">
                                    <div class="row row-cols-md-2 row-cols-1 align-items-center">
                                        ...
                                        <div class="col">
                                            <a class="hero__slider--thumbnail bideo__play--icon glightbox" style="margin-left: 150px" href="https://www.youtube.com/watch?v=Pd9pVsMVXHc" data-gallery="video">
                ...
                <div class="row row-cols-md-2 row-cols-1  align-items-center">
                    <div class="col">
                        <div class="image__with--text__thumbnail">
                            ...
                            <img class="display-block" src="../assets/img/paf/power-airfryer-benefits.jpg" alt="drone-image">
                        </div>
                    </div>
                    <div class="col">
                        <div class="image__with--text__content">
                            <h2 class="image__with--text__title mb-18">The Power Air Fryer 5L is just the perfect addition to your kitchenware. </h2>
                            <p class="image__with--text__desc mb-25">The ShopEX Power AirFryer is the number 1 Best-Selling AirFryer brand and the LARGEST size you can get from the local market. A 2L or 3L AirFryer from other brands may cost you as much or even more. But you can get the Power AirFryer XL (5L) even at a lesser price from ShopEX. You also get the Pizza Pan and Cake Barrel for FREE if you order now!!!</p> 
                                ...
                                <ul>
                                    <li class="image__with--text__percent--list mb-25">
                                        <span class="image__with--text__percent--top d-flex justify-content-between align-content-center">
                                            <span class="image__with--text__percent--content">Healthy Meals</span>
                                            <span class="image__with--text__percent--content">100%</span>
                                        </span>
                                    </li>
                                    <li class="image__with--text__percent--list two">
                                        <span class="image__with--text__percent--top d-flex justify-content-between align-content-center">
                                            <span class="image__with--text__percent--content">Nonstick Surface</span>
                                            <span class="image__with--text__percent--content">100%</span>
                                        </span>
                                    </li>
                                </ul>
                            ...
                            <div class="image__with--text__content--footer d-flex">
                                ...
                                <p class="image__with--text__desc mb-25">
                                    But that’s not all, we would also deliver to your location of choice (within Nigeria, including Lagos, Abuja, Port Harcourt, and other towns and cities across Nigeria) FREE of charge. Also, enjoy safe payment, dedicated after-sales support, 30 days return guarantee (if the product has problems).</p>
                            </div>    
                        </div>
                    </div>
                </div>
                ...
                <div class="row row-cols-lg-2 row-cols-md-2 row-cols-1 align-items-center">
                    <div class="col">
                        <div class="about__content">
                            <h2 class="about__content--title mb-18">ShopEX TV is the Sole Authorised Distributor of The Power Air Fryer 5L in Nigeria.</h2>
                            <div class="about__content--step mb-25">
                                ...
                                <p class="about__content--desc style2">We are also the Number 1 Best Seller in Africa for the Power Air Fryer 5L. Order original only from ShopEX and enjoy FREE delivery to your location of choice within Nigeria. You are guaranteed secure payment options, dedicated after-sales support, and return (if the product has problems).</p>
                                <h2>The 6 in 1 power air fryer XL has six primary cooking functionalities.</h2>
                                <ul class="mb-20">
                                    <li class="about__content--desc__list">1. It air fries your food, crispy and brown without deep frying in oil</li>
                                    <li class="about__content--desc__list">2. Grill juicy steaks and perfectly flaky fish  </li>
                                    <li class="about__content--desc__list">3. Bake delicious pizzas and desserts like they just came out of the oven</li>
                                    <li class="about__content--desc__list">4. Saute onions and peppers</li>
                                    <li class="about__content--desc__list">5. Roast…… style old chicken</li>
                                    <li class="about__content--desc__list">6. Steam vegetables and sea foods dishes infused with flavours</li>
                                </ul>
                            </div>
                    ...
                    <div class="col">
                        <div class="about__thumbnail">
                            <img class="display-block" src="../assets/img/paf/fry-with-power-airfryer-6-ways.jpg" alt="about-thumb">
        ...
        <section class="newsletter__section newsletter__bg2_paf section--padding" id="video">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2">
                        <div class="newsletter__content--style2 text-center position__relative">
                           
                            <a class="bideo__play--icon banner__video--play__icon style4 glightbox" href="https://www.youtube.com/watch?v=Pd9pVsMVXHc" data-gallery="video">
        ...
        <section class="newsletter__section section--padding">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <iframe width="520" height="315" src="https://www.youtube.com/embed/qG3bRFmaEy4?autoplay=1&mute=1"></iframe>
                    </div>
                    <div class="col-md-6">
                        <iframe width="520" height="315"src="https://www.youtube.com/embed/FcP7Go-dqaY?autoplay=1&mute=1"></iframe>
...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST">
        ...
        <section class="product__details--section section--padding" id="buy" style="background: #eeeeee4a;">
            <div class="container">
                <div class="section__heading text-center mb-50">
                    ...
                    <p class="section__heading--desc">ShopEX TV is the Sole Authorised Distributor of The Power Air Fryer 5L® in Nigeria. Enjoy Free Delivery within Nigeria! ORDER ORIGINAL ONLY FROM SHOPEX.</p>
                </div>
                    ...
                    <div class="row row-cols-lg-2 row-cols-md-2">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="product__media--nav__items">
                                                <img class="product__media--nav__items--img" src="../assets/img/paf/power-air-fryer-image.jpg" alt="product-nav-img">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product__media--nav__items">
                                                <img class="product__media--nav__items--img" src="../assets/img/paf/bake-power-airfryer.jpg" alt="product-nav-img">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product__media--nav__items">
                                                <img class="product__media--nav__items--img" src="../assets/img/paf/fry-with-power-airfryer.jpg" alt="product-nav-img">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product__media--nav__items">
                                                <img class="product__media--nav__items--img" src="../assets/img/paf/grill-power-airfryer-600x600.jpg" alt="product-nav-img">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product__media--nav__items">
                                                <img class="product__media--nav__items--img" src="../assets/img/paf/roast-power-airfryer.jpg" alt="product-nav-img">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product__media--nav__items">
                                                <img class="product__media--nav__items--img" src="../assets/img/paf/steam-power-airfryer.jpg" alt="product-nav-img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="product__media--preview__items">
                                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="../assets/img/paf/power-air-fryer-image.jpg"><img class="product__media--preview__items--img" src="../assets/img/paf/power-air-fryer-image.jpg" alt="product-media-img"></a>
                                                    <div class="product__badge">
                                                        <span class="product__badge--items sale">New</span>
                                                    </div>
                                                    <div class="product__media--view__icon">
                                                        <a class="product__media--view__icon--link glightbox" href="../assets/img/paf/power-air-fryer-image.jpg" data-gallery="product-media-preview">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="product__media--preview__items">
                                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="../assets/img/paf/bake-power-airfryer.jpg"><img class="product__media--preview__items--img" src="../assets/img/paf/bake-power-airfryer.jpg" alt="product-media-img"></a>
                                                    <div class="product__badge">
                                                        <span class="product__badge--items sale">New</span>
                                                    </div>
                                                    <div class="product__media--view__icon">
                                                        <a class="product__media--view__icon--link glightbox" href="../assets/img/paf/bake-power-airfryer.jpg" data-gallery="product-media-preview">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 18 18">
                                                                <image  width="18" height="18" xlink:href="data:image/png;base64,"/>
                                                            </svg>                                                              
                                                            <span class="visually-hidden">Media Gallery</span>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="product__media--preview__items">
                                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="../assets/img/paf/fry-with-power-airfryer.jpg"><img class="product__media--preview__items--img" src="../assets/img/paf/fry-with-power-airfryer.jpg" alt="product-media-img"></a>
                                                    <div class="product__badge">
                                                        <span class="product__badge--items sale">New</span>
                                                    </div>
                                                    <div class="product__media--view__icon">
                                                        <a class="product__media--view__icon--link glightbox" href="../assets/img/paf/fry-with-power-airfryer.jpg" data-gallery="product-media-preview">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 18 18">
                                                                <image  width="18" height="18" xlink:href="data:image/png;base64,"/>
                                                            </svg>                                                              
                                                            <span class="visually-hidden">Media Gallery</span>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="product__media--preview__items">
                                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="../assets/img/paf/grill-power-airfryer-600x600.jpg"><img class="product__media--preview__items--img" src="../assets/img/paf/grill-power-airfryer-600x600.jpg" alt="product-media-img"></a>
                                                    <div class="product__badge">
                                                        <span class="product__badge--items sale">New</span>
                                                    </div>
                                                    <div class="product__media--view__icon">
                                                        <a class="product__media--view__icon--link glightbox" href="../assets/img/paf/grill-power-airfryer-600x600.jpg" data-gallery="product-media-preview">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 18 18">
                                                                <image  width="18" height="18" xlink:href="data:image/png;base64,"/>
                                                            </svg>                                                              
                                                            <span class="visually-hidden">Media Gallery</span>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="product__media--preview__items">
                                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="../assets/img/paf/roast-power-airfryer.jpg"><img class="product__media--preview__items--img" src="../assets/img/paf/roast-power-airfryer.jpg" alt="product-media-img"></a>
                                                    <div class="product__badge">
                                                        <span class="product__badge--items sale">New</span>
                                                    </div>
                                                    <div class="product__media--view__icon">
                                                        <a class="product__media--view__icon--link glightbox" href="../assets/img/paf/roast-power-airfryer.jpg" data-gallery="product-media-preview">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 18 18">
                                                                <image  width="18" height="18" xlink:href="data:image/png;base64,"/>
                                                            </svg>                                                              
                                                            <span class="visually-hidden">Media Gallery</span>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="product__media--preview__items">
                                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="../assets/img/paf/steam-power-airfryer.jpg"><img class="product__media--preview__items--img" src="../assets/img/paf/steam-power-airfryer.jpg" alt="product-media-img"></a>
                                                    <div class="product__badge">
                                                        <span class="product__badge--items sale">New</span>
                                                    </div>
                                                    <div class="product__media--view__icon">
                                                        <a class="product__media--view__icon--link glightbox" href="../assets/img/paf/steam-power-airfryer.jpg" data-gallery="product-media-preview">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 18 18">
                                                                <image  width="18" height="18" xlink:href="data:image/png;base64,"/>
                                                            </svg>                                                              
                                                            <span class="visually-hidden">Media Gallery</span>
                        ...
                        <div class="col">
                            <div class="product__details--info">
                                    <h3 class="product__details--info__title mb-15">The Power Air Fryer 5L XL</h3>
                                    ...
                                    <div class="product__details--info__price mb-10 600p" id="wc">
                                        <span class="current__price">₦61,556.00</span>
                                    ...
                                    <div class="product__variant">
                                        ...
                                        <div class="product__variant--list mb-15">
                                            <div class="product__details--info__meta">
                                                ...
                                                <p class="product__details--info__meta--list"><strong>Product Info:</strong>  The Power Air Fryer 5L includes</p>
                                                    <p class="product_info">  5 Litre Power Air Fryer XL.</p>
                                                    <p class="product_info">    Baking Tray</p>
                                                    <p class="product_info">    Easy-Load Fry Basket</p>
                                                    <p class="product_info">    Easy-Load Basket Divider</p>
                                                    <p class="product_info">    Owner’s Manual</p>
                                                    <p class="product_info">    <strong>BONUS: </strong>Fried Favorites Recipe Cookbook</p>
                                                <p class="product__details--info__meta--list"><strong>Use little or no oil to cook preferred delicacies</strong>  </p>

                                                    <p class="product_info">    <strong>PRECISION: </strong>Turbo cyclonic air surrounds food, cooking it to crisp and juicy perfection</p>
                                                    <p class="product_info">    <strong>VARIETY: </strong>7 preset programs for different cooking varieties</p>
                                                    <p class="product_info">    <strong>EASE OF USE: </strong>Easy to use digital control panel cooking varieties</p>
                                                    <p class="product_info">    Auto-shutoff feature</p>
                                                    <p class="product_info">    Seven preset cooking function</p>
                                                    <p class="product_info">    Digital touch panel</p>
                                                    <p class="product_info">    Crispy food within few minutes!</p>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 mb-20">
                                                <div class="checkout__input--list ">
                                                    ...
                                                    <input class="checkout__input--field border-radius-5" id="price_paf"  type="hidden" name="price_paf" value="61556">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 mb-20">
                                                <div class="checkout__input--list">
        ...
        <!-- Start deals section -->
        <section class="deals__section deals__section--bg3_wc section--padding pt-0 pb-0" id="contact">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-7 col-sm-order">
                        <div class="deals__content">
                            ...
                            <h2 class="deals__content--title text-white mb-20">ShopEX TV is the Sole Authorised Distributor of The Power Air Fryer 5L® in Nigeria.
                    ...
                    <div class="col-lg-6 col-md-5">
                        <div class="deals__thumbnail--style3 text-right">
                            <img class="deals__thumbnail--style3__img" src="../assets/img/paf/power-air-fryer-image.jpg" alt="deals-thumb">
                        </div>
                    </div>
                </div>
            </div>
         ...
         $set_entry_parameters = array(
          ...
          "name_value_list" => array(
                ...
                array("name" => "email1", "value" => $email_address ),
                 ...
                 array("name" => "power_airfryer", "value" => $qty ),
                ...
                array("name" => "pay_method", "value" => 'Bank Transfer'),
                // Pending
                array("name" => "ref_referral_contacts_1ref_referral_ida", "value" => $referral ),
                array("name" => "ref_referral_contacts_1_name", "value" => $ref_name ),
            ),
          );

          $set_entry_result = call("set_entry", $set_entry_parameters, $url);
        if ($set_entry_result) {
            echo "<script type='text/javascript'>window.top.location='https://shop.shopextv.com/paf/?status=sent';</script>"; exit;
        }
    }
 ?>